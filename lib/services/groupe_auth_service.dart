...
class GroupeAuthService {
  ...
  static Future<GroupeProfilModel> updateGroupeProfil(
    ...
    final response = await ApiService.put('/groupes/$groupeId/profil', updates);
  ...
  /// Upload photo de couverture du groupe
  static Future<Map<String, dynamic>> uploadPhotoCouverture(
    int groupeId,
    String filePath,
  ) async {
    ...
    if (response != null) {
      ...
      await updateGroupeProfil(groupeId, {'photo_couverture': response});
      return {'photo_couverture': response, 'url': response};
    } else {
      throw Exception('Erreur lors de l\'upload de la photo de couverture');
    }
  }

  /// Upload logo du groupe
  static Future<Map<String, dynamic>> uploadLogo(
    ...
    if (response != null) {
      ...
      await updateGroupeProfil(groupeId, {'logo': response});
